...
public static class Mos6502Extensions
{
    ...
    /// <param name="opcode">The opcode to test against.</param>
    /// <returns><c>true</c> if the specified opcode is a branch instruction (conditional jump, jump or return), otherwise <c>false</c>.</returns>
    public static bool IsBranch(this Mos6510OpCode opcode) => IsBranch((Mos6502OpCode)opcode);
    ...
    /// <summary>
    /// Gets the text representation of a <see cref="Mos6510Mnemonic"/>.
    /// </summary>
    /// <param name="mnemonic">The mnemonic value.</param>
    /// <param name="lowercase"><c>true</c> to get a lowercase mnemonic. Default is <c>false</c>.</param>
    /// <returns>A text representation of the mnemonic.</returns>
    public static string ToText(this Mos6510Mnemonic mnemonic, bool lowercase = false) => Mos6510Tables.GetMnemonicText(mnemonic, lowercase);
    ...
    /// <param name="opcode">The opcode.</param>
    /// <returns>The cycle count for the specified opcode.</returns>
    public static int ToCycleCount(this Mos6510OpCode opcode) => Mos6510Tables.GetCycleCountFromOpcode(opcode);
    ...
    /// <param name="opcode">The opcode.</param>
    /// <returns>The mnemonic for the specified opcode.</returns>
    public static Mos6510Mnemonic ToMnemonic(this Mos6510OpCode opcode) => Mos6510Tables.GetMnemonicFromOpcode((byte)opcode);
    ...
    /// <param name="opcode">The opcode.</param>
    /// <returns>The addressing mode for the specified opcode.</returns>
    public static Mos6502AddressingMode ToAddressingMode(this Mos6510OpCode opcode) => Mos6510Tables.GetAddressingModeFromOpcode((byte)opcode);
