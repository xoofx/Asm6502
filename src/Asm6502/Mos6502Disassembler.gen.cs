...
/// <summary>
/// The Mos6502 disassembler that converts a byte buffer into human-readable assembly instructions.
/// </summary>
...
/// <summary>
/// The Mos6510 disassembler that converts a byte buffer into human-readable assembly instructions.
/// </summary>
public class Mos6510Disassembler
{
    private readonly Dictionary<ushort, int> _internalLabels;
    private int _internalLabelId;
    private ushort _currentOffset;
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="Mos6510Disassembler"/> class with default options.
    /// </summary>
    public Mos6510Disassembler() : this(new Mos6510DisassemblerOptions())
    {
    }

    /// <summary>
    /// Initializes a new instance of the <see cref="Mos6510Disassembler"/> class with the specified options.
    /// </summary>
    /// <param name="options">The options to use for disassembling.</param>
    public Mos6510Disassembler(Mos6510DisassemblerOptions options)
    {
        _internalLabels = new();
        Options = options;
        _tryFormatLabelDelegate = TryFormatLabel;
    ...
    /// Gets the options used for disassembling.
    /// </summary>
    public Mos6510DisassemblerOptions Options { get; }
    ...
    public void Disassemble(Span<byte> buffer, TextWriter writer)
    {
        ...
        while (position < buffer.Length)
        {
            var instruction = Mos6510Instruction.Decode(buffer.Slice(position));
            var instructionSizeInBytes = instruction.SizeInBytes;
...
/// <param name="instruction">The instruction being decoded.</param>
/// <param name="writer">The text writer to write the text.</param>
public delegate void Mos6510InstructionPrinterDelegate(ushort offset, Mos6510Instruction instruction, TextWriter writer);
...
/// <param name="charsWritten">The number of character written.</param>
/// <returns><c>true</c> if formatting the comment was successful.</returns>
public delegate bool Mos6510TryFormatInstructionCommentDelegate(ushort offset, Mos6510Instruction instruction, Span<char> destination, out int charsWritten);
